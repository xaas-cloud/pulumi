		...
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					require.Equal(
						...
						"expected explicit component provider",
					)
					...
					//
					// * from_identity, whose value should be the value output of the explicit provider.
					// * from_prefixed, whose value should be the value output of the explicit provider, prefixed with "foo-".
